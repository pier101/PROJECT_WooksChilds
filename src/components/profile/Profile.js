      ...
      useEffect(()=>{
        ...
        <Box sx={{mt:10,mx:'15%', minWidth:'300px', maxWidth:'70%', display: 'flex',borderColor:'grey.500',  flexWrap: 'nowrap',justifyContent: 'space-between'   }}>
          ...
          <Box sx={{textAlign: 'center',mt:5,ml:2,display: 'flex' }}>
              ...
              />
              <Box sx={{mt:2,ml:2,display: 'flex'}}><h1><b>{getUser.userName}</b></h1><Box sx={{textAlign: 'right',mt:3}}>님 안녕하세요</Box>
          </Box>
          </Box>
          <Box sx={{mt:2,ml:2,display: 'flex'}}>
              <Link  to='#'><Button sx={{mt:10, width: 200, height: 80, textAlign: 'center',lineHeight:5,marginRight:5}}flex='1' variant="outlined" color="error">회원정보수정</Button></Link>
